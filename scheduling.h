...
//Only the arrival time and duration are known before a process executes.
//The first_run field is updated to indicate when a process first begins executing
//Completion is the time a process completes executing.
